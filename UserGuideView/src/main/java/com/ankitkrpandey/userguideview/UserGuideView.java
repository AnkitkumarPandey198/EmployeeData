package com.ankitkrpandey.userguideview;
...
import com.ankitkrpandey.userguideview.config.DismissType;
import com.ankitkrpandey.userguideview.config.Gravity;
import com.ankitkrpandey.userguideview.config.PointerType;
import com.ankitkrpandey.userguideview.listener.UserGuideListener;
...
public class UserGuideView extends FrameLayout {
    ...
    private UserGuideListener mGuideListener;
    private Gravity mGravity;
    private DismissType dismissType;
    private PointerType pointerType;
    private final UserGuideMessageView mMessageView;

    public UserGuideView(@NonNull Context context, View view) {
        super(context);
        ...
        mMessageView = new UserGuideMessageView(getContext());
    ...
    public int getNavigationBarSize() {
        ...
        @SuppressLint("InternalInsetResource") int id = resources.getIdentifier("navigation_bar_height_landscape", "dimen", "android");
        if (id > 0) {
    ...
    public static class Builder {
        ...
        private UserGuideListener guideListener;
         ...
         **/
        public Builder setUserGuideListener(UserGuideListener guideListener) {
        ...
        public UserGuideView build() {
            UserGuideView guideView = new UserGuideView(context, targetView);
